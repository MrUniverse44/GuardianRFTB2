...
import me.blueslime.stylizedrftb.multiarena.interfaces.DataInfo;
import me.blueslime.stylizedrftb.multiarena.interfaces.DataStorage;
import me.blueslime.stylizedrftb.multiarena.interfaces.MySQL;
...
public class DataStorageImpl implements DataStorage {
    private StylizedRFTB plugin;
    private DataInfo dataInfoImpl;
    private MySQL mySQLImpl;
    private SQL sqlImpl;


    public DataStorageImpl(StylizedRFTB main) {
        plugin = main;
    ...
    @Override
    public void setPlugin(StylizedRFTB plugin) { this.plugin = plugin; }
