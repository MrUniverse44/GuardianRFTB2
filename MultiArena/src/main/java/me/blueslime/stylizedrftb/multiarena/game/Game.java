...
import me.blueslime.stylizedrftb.multiarena.utils.LocationUtils;
import org.bukkit.*;
...
public abstract class Game {
    ...
    public Game(StylizedRFTB plugin, String name) {
    ...
    public Game(StylizedRFTB plugin, String name, String customName) {
